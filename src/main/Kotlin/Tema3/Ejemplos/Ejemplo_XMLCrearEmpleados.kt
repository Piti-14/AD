...
fun main(args: Array<String>) {
    ...
    trans.setOutputProperty(OutputKeys.INDENT, "yes") //Escribir el documento de forma indentada
    trans.setOutputProperty("{http://xml.apache.org/xslt}indent-amount", "2") //Escribir el documento de forma indentada
